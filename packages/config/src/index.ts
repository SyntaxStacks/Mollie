...
const baseEnvSchema = z.object({
  ...
  CATALOG_LOOKUP_MODE: z.enum(["internal", "fixture"]).default("internal"),
...
const connectorEnvSchema = baseEnvSchema.extend({
  ...
  CONNECTOR_PORT: z.coerce.number().int().positive().default(4010),
  ...
  BROWSER_GRID_URL: z.string().url().optional()
});
