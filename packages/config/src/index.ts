...
const baseEnvSchema = z.object({
  ...
  AMAZON_CATALOG_LOOKUP_MODE: z.enum(["manual", "fixture", "amazon_paapi5"]).default("manual"),
  ...
  AMAZON_PAAPI_HOST: z.string().default("webservices.amazon.com"),
  AMAZON_PAAPI_REGION: z.string().default("us-east-1"),
